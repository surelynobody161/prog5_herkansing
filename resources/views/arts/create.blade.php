<x-layout>
    <form action="{{ route('arts.store') }}" method="POST" class="space-y-6 bg-gray-800 p-8 rounded-lg shadow-lg" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            <label for="categories[]" class="block text-lg font-medium text-gray-300 mb-1">Categorieën:</label>
